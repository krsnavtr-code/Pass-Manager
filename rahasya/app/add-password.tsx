      ...
      >
        ...
        >
          ...
          <View
            style={[
              styles.sectionCard,
              { backgroundColor: isDark ? "#0F172A" : "#FFFFFF", borderColor },
            ]}
          >
            ...
            {[
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.catBtn,
                  {
                    backgroundColor: category === cat.v ? "#3B82F6" : inputBg,
                    borderColor: category === cat.v ? "#3B82F6" : borderColor,
                  },
                ]}
              >
                ...
                <ThemedText
                  style={[
                    styles.catLabel,
                    { color: category === cat.v ? "#FFF" : textColor },
                  ]}
                >
                  {cat.l}
                </ThemedText>
